...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2021 at 05:48 AM
...
(1, 'admin', '$2y$10$g4m/PfziRBxoM9fvwqiS9OgxAV29w0y8..XHruyEplYPxYnhZJ6bC', 'Erick', 'Omundi', 'avatar.png', '2018-04-02');
...
CREATE TABLE `constituency` (
  ...
  `RegisteredVoters.` int(100) NOT NULL
...
INSERT INTO `constituency` (`ConstituencyName`, `RegisteredVoters.`) VALUES
('Anguilla', 10000),
('Antigua - South', 9980),
('Antigua – East', 12300),
('Antigua – North', 11200),
...
('Nevis', 29382),
('St. Kitts - South', 8320),
('St. Kitts – Central', 13002),
('St. Kitts – North', 12034);
...
INSERT INTO `party` (`PartyName`, `PartyLeader`, `FundRaised`) VALUES
('Democratic Alliance Party', 'John Kamau', 785450),
('Freedom Party\r\n', 'Rao Njoo', 8569475),
('People\'s Party', 'Alex Gichu', 4758214);
...
(18, 'FZcNPi7DXKlGnb2', '$2y$10$S7Cs8Lv2mDjGBwqlkpneqOmXYE5NcdNspHkDNKGrospgacp2reCu.', 'Micky', 'ress', 'Screenshot (149).png');
...
ALTER TABLE `constituency`
  ADD PRIMARY KEY (`ConstituencyName`);

--
-- Indexes for table `party`
--
ALTER TABLE `party`
  ADD PRIMARY KEY (`PartyName`);
